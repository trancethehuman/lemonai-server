...
export interface ChannelCloseParams {
  channelId: string;
}
...
export interface ChannelGetAllParams {
  returnAll?: boolean;
  limit?: number;
  filters?: {
...
export interface ChannelLeaveParams {
  channelId: string;
}
...
export interface ChannelRenameParams {
  channelId: string;
  name: string;
}
...
export interface ChannelSetPurposeParams {
  channelId: string;
  purpose: string;
}
export interface ChannelSetTopicParams {
  channelId: string;
  topic: string;
}
...
export interface StarAddParams {
  target: 'message' | 'file';
  channelId: string;
  fileId?: string;
  timestamp?: number;
...
export interface StarDeleteParams {
  options?: {
    channelId?: string;
    fileId?: string;
    fileComment?: string;
...
export interface StarGetAllParams {
  returnAll?: boolean;
  limit?: number;
}
export interface FileGetAllParams {
  returnAll?: boolean;
  limit?: number;
  filters?: {
    channelId?: string;
...
export interface UserGetPresenceParams {
  user: { value: string; mode: string };
}
...
export interface UserGroupDisableParams {
  userGroupId: string;
  options?: {
    include_count?: boolean;
  };
}
export interface UserGroupEnableParams {
  userGroupId: string;
  options?: {
    include_count?: boolean;
  };
}
export interface UserGroupGetAllParams {
  returnAll?: boolean;
  limit?: number;
  options?: {
    include_count?: boolean;
